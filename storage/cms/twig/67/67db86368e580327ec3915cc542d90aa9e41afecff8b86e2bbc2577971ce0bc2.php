...
/* /var/www/vhosts/gp2m-fnyk.accessdomain.com/uneforetdepossibilites.com/themes/cifq/pages/faq.htm */
class __TwigTemplate_1fd41630fc64df37788f053832e33aa5f198d8ce56bcf93b87159076503af696 extends Twig_Template
{
...
";
    ...
    {
        return "/var/www/vhosts/gp2m-fnyk.accessdomain.com/uneforetdepossibilites.com/themes/cifq/pages/faq.htm";
    }
        ...
        <div class=\"page__content\" data-fade-in-element>
            ...
            <div class=\"container\">
                <div class=\"carousel\">
                    ...
                    <!-- CTA slide with video -->
                    <div class=\"slide slide--cta slide--cta-video\">
                        <a class=\"cta\" href=\"{{ 'voxpop' | page }}#jouer\">
                            <div class=\"cta__image\"
                                 style=\"background-image: url({{ 'assets/public/images/voxpop-avenir.jpg' | theme }})\">
                                 <div class=\"cta__overlay\">
                                     <div class=\"cta__content\">
                                         <div class=\"circle-button circle-button--play\">
                                             <div class=\"circle-button__icon\">
                    ...
                    {% for slide in slides %}
                        <div class=\"slide slide--text\">
                            ...
                            <div class=\"slide__tool\">
                                <div class=\"slide__name\">{{ slide.name }}</div>
                                <div class=\"slide__tip\"></div>
                            </div>
                            <h2 class=\"slide__title\">{{ slide.title }}</h2>
                            <div class=\"slide__text\">
                                {{ slide.excerpt | raw }}
                                {% if slide.more %}<a href=\"#\" data-read-more=\"{{ slide.number }}\">Lire la suite</a>{% endif %}
                            </div>
                        </div>
                    {% endfor %}
        ...
        <div class=\"faq-lightbox faq-lightbox--answers\" style=\"display:none\" data-hide-faq-lightbox>
            <div class=\"container\" data-nop>
                ...
                <div id=\"faq-answers-content\">
                    <!-- text slides (full) -->
                    {% for slide in slides %}
                        <div class=\"slide slide--lightbox\" data-slide-number=\"{{ slide.number }}\">
    ...
    <div class=\"content\">
        ...
        <div class=\"page__title\">
            <div class=\"container\">
                <h1 class=\"page__title-text\"><span>Big spaces, </span><span>big questions<span></h1>
                <picture class=\"page__title-img\">
                    <img src=\"{{ 'assets/public/images/faq-title-en.png' | theme }}\" alt=\"Grands espaces, big questions\">
                </picture>
            </div>
        </div>
                ...
                <div class=\"carousel\">
                    ...
                    {% for slide in slidesEN %}
                        <div class=\"slide slide--text\">
                            ...
                            <div class=\"slide__text\">
                                {{ slide.excerpt | raw }}
                                {% if slide.more %}<a href=\"#\" data-read-more=\"{{ slide.number }}\">Read more</a>{% endif %}
                            </div>
                        </div>
                    {% endfor %}
                    ...
                    <div class=\"slide slide--last slide--cta\">
                        <div class=\"cta\">
                            <div class=\"slide__title\">{{ 'Mieux on connait notre forêt, plus on est en mesure de l’apprécier et la protéger.'|_ }}</div>
                            <div class=\"cta-button\">
                                <a href=\"#\" data-show-faq-lightbox=\"faq-lightbox--form\">
...
{% endif %}", "/var/www/vhosts/gp2m-fnyk.accessdomain.com/uneforetdepossibilites.com/themes/cifq/pages/faq.htm", "");
    }
}
