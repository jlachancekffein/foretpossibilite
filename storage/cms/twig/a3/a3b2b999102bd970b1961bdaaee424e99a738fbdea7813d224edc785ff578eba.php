...
/* /home/vagrant/code/themes/cifq/layouts/default.htm */
class __TwigTemplate_d2b66c1dc4c9b8370b3aed4f8ee5cff72508692a218b7c5a9a7a66ff91e35046 extends Twig_Template
{
...
<html class=\"";
        ...
        echo " ";
        echo twig_escape_filter($this->env, ($context["pageClass"] ?? null), "html", null, true);
        echo " \" lang=\"";
        echo twig_escape_filter($this->env, ($context["locale"] ?? null), "html", null, true);
        echo "\">
    <head>
        ...
        echo twig_escape_filter($this->env, ($context["pageDescription"] ?? null), "html", null, true);
        echo "\">
        ...
        // line 26
        echo twig_escape_filter($this->env, ($context["pageKeywords"] ?? null), "html", null, true);
        echo "\">
    ...
    <body>
        ...
        if (array_key_exists("possibility", $context)) {
            echo twig_escape_filter($this->env, (" " . ($context["possibility"] ?? null)), "html", null, true);
        }
        echo "\">
            ";
        // line 68
        ...
        ";
        // line 76
        if ((($context["is_staging"] ?? null) || ($context["is_prod"] ?? null))) {
            // line 77
            echo "            <script src=\"";
    ...
    {
        return "/home/vagrant/code/themes/cifq/layouts/default.htm";
    }
    ...
    {
        return new Twig_Source("", "/home/vagrant/code/themes/cifq/layouts/default.htm", "");
    }
}
